...
const AboutMeText = () => {
  return (
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <p>
        I’m Deborah, a web developer instructor with a passion for teaching and
        coding. I specialize in React and full_stack development, helping
        students build real-world projects and master modern web technologies. I
        also run a whatsapp platform, AdvancedknowledgetechACademy where I
